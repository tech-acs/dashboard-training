...
3. Start the application (Laravel Sail)
    ...
    **Linux / macOS / WSL:** `./vendor/bin/sail up`

    **Windows:** `bash vendor/bin/sail up`

4. Install npm packages and build assets

    **Linux / macOS / WSL:** `./vendor/bin/sail npm install && ./vendor/bin/sail npm run build`

    **Windows:** `bash vendor/bin/sail npm install && bash vendor/bin/sail npm run build`

5. Migrate the main application database

    **Linux / macOS / WSL:** `./vendor/bin/sail artisan migrate`

    **Windows:** `bash vendor/bin/sail artisan migrate`
 
6. Create an administrator account (management account) 

    **Linux / macOS / WSL:** `./vendor/bin/sail artisan adminify`
    
    **Windows:** `bash vendor/bin/sail artisan adminify`
