...
- **Flexible Depth:** Users can choose to apply filters at any tier — viewing data for an entire region or narrowing the scope down to the most granular local level (EA).
