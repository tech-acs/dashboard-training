...
Please open this text file and explore and understand it. You will not be able to get far developing a dashboard without a thorough understanding of the dictionary. The dictionary will help you find the various columns (items) of interest in the various tables such as age, sex, etc.
